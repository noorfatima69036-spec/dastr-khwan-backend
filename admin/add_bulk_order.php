...
// unit_type (box/kg) bhi ab save ho raha hai
$itemStmt = $conn->prepare("INSERT INTO bulk_order_items (bulk_order_id, item_name, category, quantity, price, unit_type) VALUES (?, ?, ?, ?, ?, ?)");
foreach ($items as $item) {
    ...
    $itemStmt->bind_param("issids", $bulk_order_id, $itemName, $category, $quantity, $price, $unitType);
    $itemStmt->execute();
}
